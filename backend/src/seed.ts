...
async function bootstrap() {
  ...
  const activityRepo = appContext.get<Repository<Activity>>(getRepositoryToken(Activity))
  ...
  await attendanceRepo.createQueryBuilder().delete().from(AttendanceRecord).execute()
